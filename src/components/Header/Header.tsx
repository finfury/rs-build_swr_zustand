    ...
    <>
      ...
      <header className={styles.header}>
        ...
        <div className={clsx(styles.headerSidebar, activeMenu && styles.active)}>
          <h6 className={styles.headerSidebarTitle}><span>Навигация</span></h6>
          <ul className={styles.headerSidebarList}>
            <li onClick={() => setActiveMenu(false)} className={styles.headerSidebarItem}>
              <NavLink to='/users' className={styles.headerSidebarItemLink}>Users</NavLink>
            </li>
            <li onClick={() => setActiveMenu(false)} className={styles.headerSidebarItem}>
              <NavLink to='/posts' className={styles.headerSidebarItemLink}>Posts</NavLink>
            </li>
          </ul>
        </div>
